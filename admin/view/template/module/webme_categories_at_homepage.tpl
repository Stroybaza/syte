    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
          <tr>
            ...
            <td><div class="scrollbox" style="height: 500px; width: 800px;">
                <?php $class = 'odd'; ?>
        ...
        <tr>
          ...
          <td><input type="text" name="webme_categories_at_homepage_limit" value="<?php echo $webme_categories_at_homepage_limit; ?>" size="1" />

...
$to = "retail@sk42.ru"; //получатель уведомлений

// не трогать
$HTTP_HOST = parse_url ("http://".$_SERVER["HTTP_HOST"]); 
$HTTP_HOST = str_replace (array ("http://","www."), "", $HTTP_HOST["host"]);
$from = "retail@sk42.ru"; // отправитель. Если настраиваете smtp, не забудьте указать в $from вашу почту
...
/*
	...
	<authentification>    
	<username>kogan@sk42.ru</username>   
	<password>123123qqqq</password>   
	</authentification>   
	<message> 
	<sender>Стройбаза</sender>    
	<text>'.$msg.'</text>   
	</message>    
	<numbers> 
...
*/
	...
	$subj     = "0927edc8a716cfeb"; // + номер через пробел
	$msgtext  = "[SENDER]Стройбаза[/SENDER]";
	$msgtext .= "[SMS]" . $msg . "[/SMS]";
